...
<div id="main_container">
    ...
    <div class="main_content" style="height: 400px;padding-bottom: 0px;">
                   ...
                   <li><a href="index.jsp">系统管理员首页</a></li>
                    <li><a href="#" onclick="doQuery()">退货信息修改</a>
...
<table id="rounded-corner" align="center">
	...
	<form action="/Supermarket/uReturngoodsInfo" method="post">
	
<tr>
  
   <td><input type="text" value='${ReturngoodsInfo.advice}' name="ReturngoodsInfo.advice" size="5"/></td>
  
   
  
    <input type="hidden" value="${ReturngoodsInfo.returngoodsID}" id="hidId"/>
    
    </tr>
	
	</form>
	<form action="/Supermarket/qReturngoodsInfo" method="post">
	</form>
    	</tbody>
</table>

	 <a href="#" onclick="save1()"  class="bt_green" ><span class="bt_green_lft"></span><strong>取消</strong><span class="bt_green_r"></span></a>
      <a href="#" onclick="save('${ReturngoodsInfo.returngoodsID}')" class="bt_green" ><span class="bt_green_lft"></span><strong>确定</strong><span class="bt_green_r"></span></a>
