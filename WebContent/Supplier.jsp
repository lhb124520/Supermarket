...
<script>
	...
	function doQuery() {
		document.forms[0].action = "/Supermarket/qSupplier";
		document.forms[0].submit();
	}
	function doUpdate(id) {
		document.getElementById('hidId').value = id;

		document.forms[0].action = "/Supermarket/gSupplier";

		document.forms[0].submit();
	}
	function doDelete(id) {
		if (confirm("你确定删除该供应商吗？")) {
			document.getElementById('hidId').value = id;
			document.forms[0].action = "/Supermarket/dSupplier";
			document.forms[0].submit();
		}
...
<div id="main_container">
    ...
    <div class="main_content" style="height: 400px;padding-bottom: 0px;">
                   ...
                   <li><a href="index.jsp">系统管理员首页</a></li>
                    <li><a href="#" onclick="doQuery()">供应商信息管理</a>
...
<table id="rounded-corner">
    <thead>
    	<tr>
    	    <th scope="col" class="rounded">供应商号</th>
	...
	<c:forEach items="${result1}" var="supplier">
<tr>
	<td>${supplier.supplierID}</td>
   <td>${supplier.supplierName}</td>
   <td>${supplier.contactsName}</td>
   <td>${supplier.contactsPhone}</td>
   <td>${supplier.supplierAddress}</td>
   <td>${supplier.remarks}</td>
   <td>
   <a href="#" onclick="doUpdate('${supplier.supplierID}')">
   <img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
   <td>
   <a href="#" class="ask" onclick="doDelete('${supplier.supplierID}')">
   <img src="images/trash.png" alt="" title="" border="0" class="btnRemove"/>
	 ...
	 <a href="Supplier_add.jsp" onclick="" class="bt_green" ><span class="bt_green_lft"></span><strong>添加供应商信息</strong><span class="bt_green_r"></span></a>
