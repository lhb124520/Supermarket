...
<script>
	...
	function doQuerytwo() {
		document.forms[0].action = "/Supermarket/querytwo";
	...
	function doQuery() {
		document.forms[0].action = "/Supermarket/qReturngoodsInfo";
		document.forms[0].submit();
	}
	function doUpdate(id) {
		document.getElementById('hidId').value = id;

		document.forms[0].action = "/Supermarket/gReturngoodsInfo";
	...
	function doDelete(id) {
		if (confirm("你确定删除该退货信息吗？")) {
			document.getElementById('hidId').value = id;
			document.forms[0].action = "/Supermarket/dReturngoodsInfo";
			document.forms[0].submit();
		}
...
<div id="main_container">
    ...
    <div class="main_content" style="height: 400px;padding-bottom: 0px;">
                   ...
                   <li><a href="index.jsp">系统管理员首页</a></li>
                    <li><a href="#" onclick="doQuery()">退货信息管理</a>
...
<table id="rounded-corner">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">审批意见</th>
	...
	<c:forEach items="${result3}" var="stockInfo">
<tr>
   <td>${stockInfo.returngoodsID}</td>
   <td>${stockInfo.userName}</td>
   <td>${stockInfo.saleID}</td>
  
   <td>${stockInfo.returnGoodsInPrice}</td>
   <td>${stockInfo.returnGoodsNum}</td>
   <td>${stockInfo.returnGoodsReason}</td>
   <td>${stockInfo.advice}</td>
   <td>
   <a href="#" onclick="doUpdate('${stockInfo.returngoodsID}')">
   <img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
   <td>
   <a href="#" class="ask" onclick="doDelete('${stockInfo.returngoodsID}')">
