...
<table id="rounded-corner">
	...
	<form action="/Supermarket/aBuyer" method="post">
	
<tr> 
   
   <td>请选择供应商名称:<br><select name="buyer.supplierName">
          <c:forEach items="${result1}" var="move">
   			<option>${move.supplierName}</option>	
           </c:forEach>
                 </select>
    </td> 
    
   <td><input type="text" placeholder="请输入仓库名称" size="15" name="buyer.storeName"/></td>   
   <td><input type="text" placeholder="请输入商品名称"  size="15" name="buyer.goodsName"/></td>
   <td><input type="text" placeholder="请输入商品进价" size="15" name="buyer.goodsInPrice"/></td>
    <td><input type="text" placeholder="请输入进货数量" size="15" name="buyer.goodsNum"/></td>
  <td><input type="hidden" size="10" name="buyer.userName" value='${username}' /></td>
