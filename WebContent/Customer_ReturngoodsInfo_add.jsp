...
<table id="rounded-corner">
    <thead>
    	<tr>       	
            ...
            <th scope="col" class="rounded" colspan="2">退货原因</th>           
	...
	<form action="/Supermarket/aCustomer" method="post">
	
<tr> 
   
   <td>请选择订单号:<br><select name="customer.saleID">
          <c:forEach items="${Customer}" var="move">
   			<option>${move.saleID}</option>	
           </c:forEach>
                 </select>
    </td> 
    
   <td><input type="text" placeholder="请输入销售单价" size="15" name="customer.returnGoodsInPrice"/></td>   
   <td><input type="text" placeholder="请输入退货数量"  size="15" name="customer.returnGoodsNum"/></td>
   <td><input type="text" placeholder="请输入退货原因" size="15" name="customer.returnGoodsReason"/></td>
  <td><input type="hidden" size="10" name="customer.userName" value='${username}' /></td>
