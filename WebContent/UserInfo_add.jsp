...
<div id="main_container">
    ...
    <div class="main_content" style="height: 400px;padding-bottom: 0px;">
                   ...
                   <li><a href="index.jsp">系统管理员首页</a></li>
                    <li><a href="#" onclick="doQuery()">添加员工信息</a>
...
<table id="rounded-corner">
	...
	<form action="/Supermarket/abook" method="post">
	
<tr> 
   <td><input type="text" placeholder="请输入姓名" size="10" name="user.userName"/></td>
   <td><input type="text" placeholder="请输入密码" size="10" name="user.password"/></td>   
   <td><input type="text" placeholder="请输入性别"  size="10" name="user.sex"/></td>
   <td><input type="text" placeholder="请输入手机号码" size="15" name="user.phone"/></td>
   <td><input type="text" placeholder="请输入家庭地址" size="15" name="user.address"/></td>
  <td><input type="text" placeholder="请输入职位"  size="10" name="user.position"/></td>
