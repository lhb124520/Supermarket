...
<table id="rounded-corner">
	...
	<form action="/Supermarket/aSupplier" method="post">
	
<tr> 
   <td><input type="text" placeholder="请输入供应商名" size="10" name="supplier.supplierName"/></td>   
   <td><input type="text" placeholder="请输入联系人名字" size="10" name="supplier.contactsName"/></td>   
   <td><input type="text" placeholder="请输入电话"  size="10" name="supplier.contactsPhone"/></td>
   <td><input type="text" placeholder="请输入地址" size="15" name="supplier.supplierAddress"/></td>
   <td><input type="text" placeholder="请输入备注" size="15" name="supplier.remarks"/></td>
