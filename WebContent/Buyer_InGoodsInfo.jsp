...
<script>
	...
	function doQuery() {
		document.forms[0].action = "/Supermarket/qBuyer";
		document.forms[0].submit();
	}
	function doUpdate(id) {
		document.getElementById('hidId').value = id;

		document.forms[0].action = "/Supermarket/gBuyer";
	...
	function doDelete(id) {
		if (confirm("你确定删除该商品吗？")) {
			document.getElementById('hidId').value = id;
			document.forms[0].action = "/Supermarket/dBuyer";
			document.forms[0].submit();
		}

	}
	function doQueryone() {
		document.forms[0].action = "/Supermarket/querySupplierName";
...
<div id="main_container">
    ...
    <div class="main_content" style="height: 400px;padding-bottom: 0px;">
                   ...
                   <li><a href="Buyer.jsp">采购员首页</a></li>
                    <li><a href="#" onclick="doQuery()">采购员进货窗口</a>
...
<tr>
   <td>${supplier.goodsID}</td>
   <td>${supplier.userName}</td>
   <td>${supplier.supplierName}</td>
   <td>${supplier.storeName}</td>
   <td>${supplier.goodsName}</td>
   <td>${supplier.goodsInPrice}</td>
   <td>${supplier.goodsNum}</td>
   <td>
   <a href="#" onclick="doUpdate('${supplier.goodsID}')">
   <img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
   <td>
   <a href="#" class="ask" onclick="doDelete('${supplier.goodsID}')">
   <img src="images/trash.png" alt="" title="" border="0" class="btnRemove"/>
	 ...
	 <a href="#" onclick="doQueryone()" class="bt_green" ><span class="bt_green_lft"></span><strong>添加商品信息</strong><span class="bt_green_r"></span></a>
