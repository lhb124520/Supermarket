...
<script>
	...
	function doQuery() {
		document.forms[0].action = "/Supermarket/qCustomer";
		document.forms[0].submit();
	}
	function doUpdate(id) {
		document.getElementById('hidId').value = id;

		document.forms[0].action = "/Supermarket/gCustomer";

		document.forms[0].submit();
	}
	function doDelete(id) {
		if (confirm("你确定删除该退货信息吗？")) {
			document.getElementById('hidId').value = id;
			document.forms[0].action = "/Supermarket/dCustomer";
			document.forms[0].submit();
		}

	}
	function doQueryone() {
		document.forms[0].action = "/Supermarket/querySaleID";
...
<div id="main_container">
    ...
    <div class="main_content" style="height: 400px;padding-bottom: 0px;">
                   ...
                   <li><a href="Customer.jsp">顾客首页</a></li>
                    <li><a href="#" onclick="doQuery()">顾客退货窗口</a>
...
<table id="rounded-corner">
    <thead>
    	<tr>
        	<th scope="col" class="rounded">退货单号</th>
            ...
            <th scope="col" class="rounded">审批情况</th>
...
<tr>
   <td>${supplier.returngoodsID}</td>
   <td>${supplier.userName}</td>
   <td>${supplier.saleID}</td>
   <td>${supplier.returnGoodsInPrice}</td>
   <td>${supplier.returnGoodsNum}</td>
   <td>${supplier.returnGoodsReason}</td>
   <td>${supplier.advice}</td>
   
   
   <td>
   <a href="#" onclick="doUpdate('${supplier.returngoodsID}')">
   <img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
   <td>
   <a href="#" class="ask" onclick="doDelete('${supplier.returngoodsID}')">
   <img src="images/trash.png" alt="" title="" border="0" class="btnRemove"/>
	 ...
	 <a href="#" onclick="doQueryone()" class="bt_green" ><span class="bt_green_lft"></span><strong>添加退货信息</strong><span class="bt_green_r"></span></a>
