...
<div id="main_container">
    ...
    <div class="main_content" style="height: 400px;padding-bottom: 0px;">
                   ...
                   <li><a href="index.jsp">系统管理员首页</a></li>
                    <li><a href="#" onclick="doQuery()">员工信息修改</a>
...
<table id="rounded-corner" align="center">
	...
	<form action="/Supermarket/ubook" method="post">
	
<tr>
 
   <td><input type="text" value='${User.userName}' name="User.userName" size="5"/></td>
   <td><input type="text" value='${User.password}' name="User.password" size="5"/></td>
   <td><input type="text" value='${User.sex}' name="User.sex" size="3"/></td>
   <td><input type="text" value='${User.phone}' name="User.phone" size="10"/></td>
   <td><input type="text" value='${User.address}' name="User.address" size="10"/></td>
   <td><input type="text" value='${User.position}' name="User.position" size="10"/></td>
  
    <input type="hidden" value="${user.userID}" id="hidId"/>
	...
	<form action="/Supermarket/qbook" method="post">
	 ...
	 <a href="#" onclick="save1()"  class="bt_green" ><span class="bt_green_lft"></span><strong>取消</strong><span class="bt_green_r"></span></a>
      <a href="#" onclick="save('${user.userID}')" class="bt_green" ><span class="bt_green_lft"></span><strong>确定</strong><span class="bt_green_r"></span></a>
