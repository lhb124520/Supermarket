...
<script src="jquery.jclock-1.2.0.js" type="text/javascript"></script>
...
<div id="main_container">
    ...
    <div class="main_content" style="height: 400px;padding-bottom: 0px;">
                    ...
                    <form method="post">  
                    <li><a href="#" onclick="doQuery1()">供应商信息管理</a>
                    </form>
                    </li>
                    <li><a href="#" onclick="doQuery2()">库存商品管理</a>
                   
                    </li>
                    <li><a href="#" onclick="doQuery3()">退货信息管理</a>
                    
                    </li>
                    <li><a href="#" onclick="doQuery4()">进货信息查询</a></li>
                    
                     <li><a href="#" onclick="doQuery5()">商品销售查询</a></li>
