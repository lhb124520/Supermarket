package com.icss.Supermarket.SaleInfo.domain;
...
public SaleInfo(int saleID, String userName, String goodsName, float goodsInPrice, int goodsNum, String goodsTime) {
	super();
	SaleID = saleID;
	UserName = userName;
	GoodsName = goodsName;
